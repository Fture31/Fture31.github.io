...
const testimonials = [
  {
    ...
    content: "La collaboration avec HydroBuild sur le projet de barrage a été exceptionnelle. Leur expertise technique et leur rigueur professionnelle ont permis de livrer l'ouvrage dans les délais impartis avec une qualité irréprochable.",
    rating: 5,
  ...
  },
  {
    ...
    content: "Nous avons confié à HydroBuild la construction de notre nouveau siège social, et le résultat est simplement impressionnant. La qualité de l'exécution et le respect scrupuleux du cahier des charges font d'eux un partenaire de choix.",
    rating: 5,
  ...
  },
  {
    ...
    name: "Ibrahim Ndiaye",
    role: "Maire",
    company: "Commune de Niakhar",
    content: "Le système d'adduction d'eau potable réalisé par HydroBuild a transformé la vie de nos habitants. Leur approche participative et leur sensibilité aux enjeux locaux ont fait toute la différence dans ce projet vital pour notre communauté.",
    rating: 5,
  ...
  },
  {
    ...
    content: "HydroBuild a démontré un engagement sincère dans notre projet d'accès à l'eau en zone rurale. Leur expertise technique s'accompagne d'une réelle préoccupation pour l'impact social et environnemental de leurs réalisations.",
    rating: 4,
